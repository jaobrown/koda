...
const IndexPage = () => (
  <Layout>
    ...
    <Section backgroundColor="#fbfbfb" padding="2rem 1rem">
      ...
      <Heading1
        color={colors.darkgray}
        style={{ textAlign: "center", fontSize: "3.5rem", margin: "30px 0" }}
      >
        we empower others through strategy and design.
      </Heading1>
      <div
        style={{
          width: "100%",
    ...
    <CtaSection>
      <Cta1 content="01" to="/work/">
        See our work
      </Cta1>
      <Cta1 content="02" to="/services/">
        View our services
      </Cta1>
      <Cta1 content="03" to="/blog/">
        Read our blog
      </Cta1>
    </CtaSection>
    <Section padding="2rem 1rem">
      <Heading2 mb="1.2rem" fontSize="1.6rem">
        You need help bringing your vision to life.
      </Heading2>
      <Text lineHeight="1.5rem" mb="1.2rem" fontSize="1.1rem">
      ...
      <Text lineHeight="1.5rem" mb="1.2rem" fontSize="1.1rem">
        Through brand strategy and identity design, we put in the work, so you
        can focus on what you need to so your dream becomes a reality.
      </Text>
      <Shape2></Shape2>
    </Section>
  </Layout>
