    ...
    <Footer backgroundColor={colors.darkgray} padding="3rem 2rem">
      ...
      <FooterContactGroupWrapper>
        <FooterContactGroup>
          ...
          <a href="mailto:alex@kodastudio.co" style={{textDecoration: 'none'}}><Text textAlign="center" color={colors.alexwhite} fontSize="1rem" fontWeight="bold" fontFamily={`'Majesti', 'serif'`}><em>alex@kodastudio.co</em></Text></a>
        </FooterContactGroup>
        <FooterContactGroup>
