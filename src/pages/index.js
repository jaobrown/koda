    ...
    <Layout>
      ...
      <Section backgroundColor="#F7F7F7" padding="7rem 1rem 5rem 1rem" lgPadding="7rem 6rem 5rem 6rem" xlPadding="7rem 18rem 5rem 18rem">
        ...
        <div style={{ width: '100%', display: 'flex', justifyContent: 'center', marginBottom: '30px' }}>
          <ButtonPill onClick={() => animateScrollTo(700)}>about koda</ButtonPill>
        </div>
      </Section>
      {/* //* End hero */}
      ...
      <Section padding="5rem 1rem" backgroundColor="#C2CBCE">
        <ServiceTextWrapper>
          <ServicesText mb="0"><ServicesLink to="/work">See our work</ServicesLink></ServicesText>
          <ServicesText mb="0"><ServicesLink to="/services">View our services</ServicesLink></ServicesText>
          <ServicesText mb="0"><ServicesLink to="/blog">Read our blog</ServicesLink></ServicesText>
        </ServiceTextWrapper>
      </Section>
      {/* //* End secondary nav */}
