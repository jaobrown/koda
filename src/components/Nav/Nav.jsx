...
const Nav = () => (
    <NavBar>
            ...
            <g transform="translate(-56.06 -368.178)">
              ...
              <g transform="translate(88.104 396.649)">
                ...
                <path
                  ...
                  transform="translate(-90.548 -398.821)"
                />
              </g>
              <path
                stroke="#3a3a3a"
                d="M111.662,372.368a3.25,3.25,0,0,0-.337.518,1.356,1.356,0,0,0-.277-.15,2.308,2.308,0,0,0-.27-.143,9.394,9.394,0,0,0-1.574-.577,13.72,13.72,0,0,0-7.578.45l-.136.053-5.877-3.494a6.4,6.4,0,0,0,.96,7.346,6.118,6.118,0,0,0,1.874,1.319,11.828,11.828,0,0,1,4.992,4.348,9.3,9.3,0,0,1,1.154,6.507.306.306,0,0,1-.307.255h-.046a.305.305,0,0,1-.255-.352,8.815,8.815,0,0,0-.847-5.7,5.525,5.525,0,0,0-.345-.57,11.286,11.286,0,0,0-4.61-3.936,6.612,6.612,0,0,1-2.053-1.454,7.02,7.02,0,0,1-.9-8.35l.157-.263,6.162,3.658a14.083,14.083,0,0,1,7.819-.412,9.613,9.613,0,0,1,1.746.645,2.3,2.3,0,0,1,.27.15A1.406,1.406,0,0,1,111.662,372.368Z"
                transform="translate(-2.707 0)"
              />
              <path
                stroke="#3a3a3a"
                d="M90.714,422.186a2.349,2.349,0,0,1-1.5-.542l-1.078-.893L86.4,418.974a12.326,12.326,0,0,1-1.5-1.857,5.146,5.146,0,0,1-.937-2.892l0-.229c-.021-1.756-.04-3.272-1.534-4.611a14.008,14.008,0,0,0-1.427-1.022c-2.353-1.562-6.29-4.176-6.6-9.222a.307.307,0,0,1,.288-.325.31.31,0,0,1,.325.287c.293,4.741,3.926,7.152,6.329,8.748a14.239,14.239,0,0,1,1.5,1.077c1.7,1.519,1.718,3.32,1.738,5.061l0,.228a4.513,4.513,0,0,0,.837,2.564,11.685,11.685,0,0,0,1.428,1.765l1.724,1.765,1.042.86a1.756,1.756,0,0,0,2.237-2.707l-1.037-.858c-.284-.176-2.951-1.9-2.859-4.415.087-2.417,0-9.923,0-10a.307.307,0,0,1,.3-.31.3.3,0,0,1,.31.3c0,.075.088,7.6,0,10.028-.082,2.24,2.557,3.864,2.583,3.88l.037.026,1.054.872a2.367,2.367,0,0,1-1.286,4.183C90.867,422.182,90.791,422.186,90.714,422.186Z"
                transform="translate(-1.299 -2.171)"
              />
              <g transform="translate(107.403 370.997)">
                <path
                  stroke="#3a3a3a"
                  d="M117.813,376.867l-4.46-5.187a4.807,4.807,0,0,0-.735.787,3.792,3.792,0,0,0-.337.518,4.88,4.88,0,0,0,.547,5.591l1.266,1.485a2.429,2.429,0,0,0,1.567.824,2.126,2.126,0,0,0,.614,0,2.359,2.359,0,0,0,1.275-.562A2.461,2.461,0,0,0,117.813,376.867Zm-.465,3.223a2.1,2.1,0,0,1-1.094.487,1.848,1.848,0,0,1-.615-.007,2.128,2.128,0,0,1-1.312-.712l-1.266-1.477a4.573,4.573,0,0,1-.5-5.247,3.249,3.249,0,0,1,.337-.518,4.528,4.528,0,0,1,.427-.494l4.258,4.948A2.153,2.153,0,0,1,117.348,380.09Z"
                  transform="translate(-111.343 -371.245)"
                />
                <path
                  stroke="#3a3a3a"
                  d="M118.022,376.639l-4.662-5.427-.232.2a5.177,5.177,0,0,0-.8.87,3.923,3.923,0,0,0-.337.524,5.2,5.2,0,0,0,.585,5.937l1.266,1.476a2.736,2.736,0,0,0,1.815.945c.1.007.187.015.277.015a2.576,2.576,0,0,0,.337-.022,2.752,2.752,0,0,0,1.754-4.52Zm-3.718,3.186-1.266-1.477a4.573,4.573,0,0,1-.5-5.247,3.246,3.246,0,0,1,.337-.518,4.53,4.53,0,0,1,.427-.494l4.258,4.948a2.153,2.153,0,0,1-.232,3.021,2.1,2.1,0,0,1-1.094.487,1.847,1.847,0,0,1-.615-.007A2.128,2.128,0,0,1,114.3,379.825Z"
                  transform="translate(-111.32 -371.212)"
                />
              </g>
            </g>
          </svg>
      ...
      <NavLinkContainer style={{ justifyContent: `flex-end` }}>
        <NavLink
          style={{ marginLeft: `3rem`, marginBottom: `-4px` }}
          modifiers="animated"
          to="/about"
        >
          about
