    ...
    <StyledFooter backgroundColor={colors.darkgray} padding="3rem 2rem">
      ...
      <FooterContactGroupWrapper>
        <FooterContactGroup>
          ...
          <a href="mailto:alex@kodastudio.co" style={{ textDecoration: 'none' }}><Text mb="1rem" textAlign="center" color={colors.alexwhite} fontSize="1rem" fontWeight="bold" fontFamily={`'Majesti', 'serif'`}><em>alex@kodastudio.co</em></Text></a>
        </FooterContactGroup>
        <FooterContactGroup>
          ...
          <Text mb="1rem" textAlign="center" color={colors.alexwhite} fontSize="1rem" fontWeight="bold" fontFamily={`'Majesti', 'serif'`}><em>Indianapolis, Indiana</em></Text>
        </FooterContactGroup>
        <FooterContactGroup>
          ...
          <Text mb="1rem" textAlign="center" color={colors.alexwhite} fontSize="1rem" fontWeight="bold" fontFamily={`'Majesti', 'serif'`}><em>M-F 9-5 EST</em></Text>
        </FooterContactGroup>
      </FooterContactGroupWrapper>
    </StyledFooter>
  )
